...
export const en = {
  ...
  "profiles.contextPrompt.hint": "Raw Markdown template generated by Memobase engine",
  ...
  "apps.name": "Name",
  "apps.slug": "Slug",
  "apps.slug.hint": "Lowercase letters, numbers, and - only (e.g. my-app)",
  ...
  "app_workspace.group.try_it": "Try It",
  "app_workspace.group.data_engines": "Data Engines",
  "app_workspace.group.config": "Configuration",

  // ── Operator mode (Step 8) ──────────────────────────────────────────
  "operator.sidebar.title": "Operator",
  "operator.dashboard": "Dashboard",
  "operator.orgs": "Organizations",
  "operator.users_mapping": "User Mapping",
  "operator.memory_raw": "Memory",
  "operator.profiles_raw": "Profiles",
  "operator.knowledge_raw": "Knowledge",
  "operator.health": "System Health",
  "operator.backup": "Backup",
  "operator.settings": "Settings",
  "operator.group.monitor": "Monitor",
  "operator.group.data": "Data",
  "operator.group.maintain": "Maintain",
  ...
  "account.subtitle": "Your login credentials and profile.",
  "account.role": "Role",
  ...
  "account.password.mismatch": "New password and confirmation don't match.",
  "account.password.wrong_old": "Current password is incorrect.",
  "account.password.same": "New password must differ from the current one.",
  "account.password.success": "Password changed — please log in again.",

  "org.title": "Organization",
  "org.subtitle_owner": "Edit name / slug. Only owners can change these.",
  "org.subtitle_member": "Your organization details. Only owners can edit.",
  "org.name": "Name",
  "org.slug": "Slug",
  "org.stats": "Stats",
  "org.developers": "developers",
  "org.apps": "apps",
  "org.edit": "Edit organization",
  "org.updated": "Organization updated.",
  "org.slug_conflict": "This slug is already taken.",

  "members.title": "Members",
  "members.subtitle": "Developers in this organization (invitations coming soon).",
  "members.col.email": "Email",
  "members.col.name": "Name",
  "members.col.role": "Role",
  "members.col.last_login": "Last login",
  ...
  "quickstart.baseUrl.hint": "URL is determined by NEXT_PUBLIC_API_URL env var and can be customized at deploy time",
  ...
  "operator.system_ok": "All engines operational",
  "operator.system_degraded": "{n} engine(s) need attention",
  "operator.engine.status.healthy": "Healthy",
  "operator.engine.status.degraded": "Degraded",
  "operator.engine.status.unhealthy": "Unhealthy",
  "operator.engine.status.disabled": "Disabled",
  "operator.engine.status.unknown": "Unknown",
  "operator.quick_actions": "Quick Actions",
  "operator.action.view_orgs": "View Organizations",
  "operator.action.view_orgs_desc": "Browse all registered orgs and apps",
  "operator.action.run_backup": "Run Backup",
