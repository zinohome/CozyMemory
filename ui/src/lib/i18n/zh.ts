...
export const zh: Record<TKey, string> = {
  ...
  "app_workspace.group.try_it": "体验",
  "app_workspace.group.data_engines": "数据引擎",
  "app_workspace.group.config": "配置",

  // ── Operator mode (Step 8) ──────────────────────────────────────────
  "operator.sidebar.title": "Operator",
  "operator.dashboard": "仪表盘",
  "operator.orgs": "组织列表",
  "operator.users_mapping": "用户映射",
  "operator.memory_raw": "对话记忆",
  "operator.profiles_raw": "用户画像",
  "operator.knowledge_raw": "知识库",
  "operator.health": "系统健康",
  "operator.backup": "备份",
  "operator.settings": "设置",
  "operator.group.monitor": "监控",
  "operator.group.data": "数据",
  "operator.group.maintain": "维护",
  ...
  // ── Account / Org / Members (Settings page) ─────────────────────────
  "account.title": "账号信息",
  "account.subtitle": "你的登录凭证和个人资料。",
  "account.role": "角色",
  "account.last_login": "最近登录",
  ...
  "account.password.wrong_old": "当前密码不正确",
  "account.password.same": "新密码不能与当前密码相同",
  "account.password.success": "密码已修改，请重新登录",

  "org.title": "组织",
  "org.subtitle_owner": "编辑组织名称和 slug。只有 owner 可修改。",
  "org.subtitle_member": "组织详情。只有 owner 可以编辑。",
  "org.name": "名称",
  "org.slug": "Slug",
  "org.stats": "统计",
  "org.developers": "位 Developer",
  "org.apps": "个 App",
  "org.edit": "编辑组织",
  "org.updated": "组织信息已更新",
  "org.slug_conflict": "该 slug 已被占用",

  "members.title": "成员",
  "members.subtitle": "当前组织下所有 Developer（邀请功能后续版本提供）。",
  "members.col.email": "邮箱",
  "members.col.name": "名字",
  "members.col.role": "角色",
  "members.col.last_login": "最近登录",
  ...
  "operator.system_ok": "所有引擎运行正常",
  "operator.system_degraded": "{n} 个引擎需要关注",
  "operator.engine.status.healthy": "健康",
  "operator.engine.status.degraded": "降级",
  "operator.engine.status.unhealthy": "异常",
  "operator.engine.status.disabled": "已禁用",
  "operator.engine.status.unknown": "未知",
  "operator.quick_actions": "快捷操作",
  "operator.action.view_orgs": "查看组织",
  "operator.action.view_orgs_desc": "浏览所有注册的组织和 App",
  "operator.action.run_backup": "数据备份",
